...
- [ ] S3.04f3 Shop section in the web editor: the section-type mirror, picker entry with thumbnail, event management UI (create/capacity/delete over the existing `/sites` ticket routes — wire them if S3.04b left them store-only), i18n en/fr/nl; tsc/eslint/build clean; manual click-path journaled.
