...
- [ ] S3.06d Wave review, final arcs and the walk a test cannot do: the three strands (direct-manipulation editing; the bot that answers and acts; tickets + stock commerce) driven end to end on the real local stack with transcripts and byte budgets, and every sites screen opened in a real browser at 360px and driven by keyboard alone, reduced-motion and contrast included; fix what it finds; then the wave closes.
