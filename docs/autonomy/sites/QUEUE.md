...
- [ ] S3.06c Wave review, as-built docs and reconciliation: `docs/design/sites.md` reconciled with what Wave 3 actually shipped, features.md [S3] table, CHANGELOG sweep, human-inbox summary (payment-provider keys, the ticket-mail sender identity, Caddy prefixes, the AI key, and the open decisions this wave flagged — the blocked S3.04e tax review first among them).
