...
- [ ] S2.14b Sandboxed custom-code UI: the block in the web section mirror, its editor (three fields, capability switches, height), the draft preview, and the visible risk boundary; render goldens already exist from S2.14a.
