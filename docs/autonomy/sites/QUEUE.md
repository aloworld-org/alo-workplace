...
- [ ] S2.13b2 Booking notification: on a new appointment, INTERNAL delivery of a notification message to the owner's inbox (never outbound), claimed at-most-once like the form and order sweeps; tests prove the message lands in the right tenant's inbox and a foreign tenant sees nothing. (Split from S2.13b 2026-08-13, mirroring the S1.16b/S1.16c1 split.)
