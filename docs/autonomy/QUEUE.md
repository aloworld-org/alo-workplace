...
- [ ] B5.05a2 Purchase orders, sending: number draw + the printed order (party generalisation of B1.16/B1.17) + covering mail draft; `POST /{id}/send` moves draft→sent in one act.
